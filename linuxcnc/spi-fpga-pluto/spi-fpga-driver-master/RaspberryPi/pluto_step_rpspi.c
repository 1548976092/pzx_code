/* Autogenerated by /home/pi/new/linuxcnc-master/bin/halcompile on Sat Oct 19 12:32:59 2019 -- do not edit */
#include "rtapi.h"
#ifdef RTAPI
#include "rtapi_app.h"
#endif
...
#line 107 "pluto_step_rpspi.comp"
...
EXTRA_SETUP() {
	...
	if (retval < 0) {
		...
		printf("ERROR: cannot map GPIO memory\n");
		return retval;
	}
	printf("firmware:-->%s\n",firmware);
	if(firmware != "")
...
FUNCTION(transfer) {
	...
	//r = (steplen_ticks << 14) | (stepspace_ticks << 8) | (dirtime_ticks );
